...
RESOLUTION=$(xrandr -q | grep -A1 'DP-1' | awk -F '+' 'NR%2==1 {print$1}' | awk '{print$3}')

select_1920_1200(){
    echo "1920x1200" > ${SCREENMODEFILE}
    i3-msg restart
}

select_1920_1080(){
    echo "1920x1080" > ${SCREENMODEFILE}
    i3-msg restart
}
select_3840_1200(){
    echo "3840x1200" > ${SCREENMODEFILE}
    i3-msg restart
}
